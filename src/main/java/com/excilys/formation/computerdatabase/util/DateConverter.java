...
public class DateConverter {
	...
	/*
	 * Matches bisextiles dates 
	 * Format : yyyy-MM-dd Still needs to be verfied to
	 * Check if it is inside the mysql timestamp range
	 */
	private static final String MYSQL_TIMESTAMP_REGEX = "^(?:(?:(?:(?:(?:[1-9]\\d)(?:0[48]|[2468][048]|[13579][26])|(?:(?:[2468][048]|[13579][26])00))(-)(?:0?2\\1(?:29)))|(?:(?:[1-9]\\d{3})(-)(?:(?:(?:0?[13578]|1[02])\\2(?:31))|(?:(?:0?[13-9]|1[0-2])\\2(?:29|30))|(?:(?:0?[1-9])|(?:1[0-2]))\\2(?:0?[1-9]|1\\d|2[0-8])))))$";
