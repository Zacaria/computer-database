...
public class ConsoleConfig {
  ...
  public static Options getConfig() {
    ...
    // Categories
    Option companies = Option.builder("e").longOpt("companies").desc("Lists the companies").build();

    Option computer = Option.builder("c").longOpt("computers")
        .desc("Lists computers, if id is provided, lists only one computer").build();

    // Enablers
    Option newParam = new Option("new", "enables the creation of computer");
    Option del =
        Option.builder("del").desc("id of the object to delete").hasArg().type(Long.class).build();
    ...
    Option id = Option.builder("id").desc("id of the computer to retrieve").hasArg()
        .type(Long.class).build();

    Option name = new Option("name", true, "name of the computer to retrieve");
    Option introduced =
        new Option("intro", true, "yyyy-MM-dd date of the introduction of the computer");
    Option discontinued =
        new Option("disco", true, "yyyy-MM-dd date of the discontinuation of the computer");

    Option company = Option.builder("com").desc("id of the company of the computer")
        .type(Long.class).hasArg().build();
